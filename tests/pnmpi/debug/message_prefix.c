 ...
 * RUN-debug: @MPIEXEC@ @MPIEXEC_NUMPROC_FLAG@ 1
 * RUN-debug:   @MPIEXEC_PREFLAGS@ @PNMPIZE@ @MPIEXEC_POSTFLAGS@
 * RUN-debug:   -m @CMAKE_CURRENT_BINARY_DIR@ -c @PNMPICONF@ -d modules
