...
C CONFIGS: preload dynamic static
C
...
C
C
C ENVIRONMENT-preload: LD_PRELOAD=@LIBPNMPIF@
C ENVIRONMENT-preload: DYLD_INSERT_LIBRARIES=@LIBPNMPIF@
C ENVIRONMENT-preload: DYLD_FORCE_FLAT_NAMESPACE=1
C
